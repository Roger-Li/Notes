...
- [Sec 1: Introduction](#sec-1-introduction)
- [Sec 2: Bayes Rule and Probability Review](#sec-2-bayes-rule-and-probability-review)
  - [Manipulate Bayes Rule](#manipulate-bayes-rule)
  - [CTR and Bernoulli distribution](#ctr-and-bernoulli-distribution)
  - [Central Limit Theorem](#central-limit-theorem)
  - [Confidence Intervals](#confidence-intervals)
    - [Gaussian approximated CI](#gaussian-approximated-ci)
    - [Non-approxiated CI with Student's $t$-distribution](#non-approxiated-ci-with-students-mathsemanticsmrowmitmimrowannotation-encoding%22applicationx-tex%22tannotationsemanticsmatht-distribution)
- [Sec 3: Traditional A/B Testing](#sec-3-traditional-ab-testing)
  - [Test the Mean Difference Between Two Groups](#test-the-mean-difference-between-two-groups)
    - [t Test](#t-test)
    - [Pooled t Procedure](#pooled-t-procedure)
    - [P-Value](#p-value)
    - [Distribution-free Tests](#distribution-free-tests)
  - [A/B Test for CTR (Chi-squared Test)](#ab-test-for-ctr-chi-squared-test)
  - [Bonferroni Correction (A/B/C/D/... Testing)](#bonferroni-correction-abcd-testing)
  - [Statistical Power](#statistical-power)
  - [A/B Testing Pitfalls](#ab-testing-pitfalls)
- [Sec 4: Bayesian A/B testing](#sec-4-bayesian-ab-testing)
  - [Epsilon-Greedy algorithm](#epsilon-greedy-algorithm)
  - [Upper Confidence Bound (UCB1) Algorithm](#upper-confidence-bound-ucb1-algorithm)
    - [Chernoff-Hoeffding's inequality](#chernoff-hoeffdings-inequality)
    - [UCB1 algorithm and properties](#ucb1-algorithm-and-properties)
    - [Regret (expected loss)](#regret-expected-loss)
  - [Conjugate priors for CTR estimates (*Beta* distribution)](#conjugate-priors-for-ctr-estimates-beta-distribution)
  - [Bayesian A/B Testing with Thompson Sampling](#bayesian-ab-testing-with-thompson-sampling)
  - [Finding a Threshold Without P-Values](#finding-a-threshold-without-p-values)
  - [Confidence Interval Approximation vs. Beta Posterior for CTR Estimation](#confidence-interval-approximation-vs-beta-posterior-for-ctr-estimation)
- [Sec 5: More on Conjugate Priors](#sec-5-more-on-conjugate-priors)
  - [Role a Dice](#role-a-dice)
    - [Categorical distribution](#categorical-distribution)
    - [Likelihood](#likelihood)
    - [Dirichlet prior](#dirichlet-prior)
    - [Posterior](#posterior)
  - [Gaussian Likelihood with Known Variance](#gaussian-likelihood-with-known-variance)
...
Where $z_{\alpha/2} = \Phi^{-1}(\alpha/2)$ and $z_{1-\alpha/2}= \Phi^{-1}(1-\alpha/2)=-z_{\alpha/2}$
